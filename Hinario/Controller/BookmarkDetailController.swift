...
class BookDetailController: UIViewController {
	...
	private let buttomControlPainel: UIBarButtonItem = {
		let buttom = UIBarButtonItem(image: #imageLiteral(resourceName: "settings"), style: .plain, target: self, action: #selector(handleControlsPainel))
		buttom.tintColor = .lightBlue
		return buttom
	}()
	
	private var buttomFavoritar: UIBarButtonItem = {
		let buttom = UIBarButtonItem(image: #imageLiteral(resourceName: "heart_favorito_off"), style: .plain, target: self, action: #selector(handleFavoritar))
	...
	override func viewDidLoad() {
		...
		self.navigationItem.setRightBarButtonItems([buttomDiaEnoite,buttomControlPainel, buttomFavoritar], animated: true)
		
	}
	
	func verificaEstadoBotaoFavorito(){
		if(verificaFavorito(idName: "\(hinarios.name)")){
			buttomFavoritar.tintColor = .red
		} else {
			buttomFavoritar.tintColor = .darkGray
		}
	}
	...
	@objc private func handleFavoritar() {
		...
		if(favoritado) {
			//			iconeFavoritoOn.setImage(UIImage(named: "heart_favorito_on"), for: UIControlState.normal)
			//			iconeFavoritoOn.alpha = 1
			buttomFavoritar.tintColor = .red
			
			let novoFavorito:Favorito = Favorito(nameFav: hinarios.name, numberFav: hinarios.number, authFav: hinarios.compositor, musicFav: hinarios.music, musicUrlFav: hinarios.musicURL!, estrofeUmFav: hinarios.estrofeUm, estrofeDoisFav: hinarios.estrofeDois, estrofeTresFav: hinarios.estrofeTres, estrofeQuatroFav: hinarios.estrofeQuatro, estrofeCincoFav: hinarios.estrofeCinco, estrofeCoroNormalFav: hinarios.estrofeCoroNormal, estrofeCoroInicioFav: hinarios.estrofeCoroInicio)
			
			adicionaFavoritos(favorito: novoFavorito)
			
		} else {
			//			iconeFavoritoOn.setImage(UIImage(named: "heart_favorito_off"), for: UIControlState.normal)
			//			iconeFavoritoOn.alpha = 0.50
			buttomFavoritar.tintColor = .darkGray
	...
	@objc func fazerDownload(_ sender: InAppPurchaseButton) {
		...
		let filePath = path.appendingPathComponent("\(hinarios.music)")
		...
		if (hinarios.musicURL == nil || hinarios.musicURL == "") {
			...
			let musicDownRef = storage.child("music/\(hinarios.music)")
	...
	func statusDownloadMusic() {
		...
		let filePathIcon = pathIcon.appendingPathComponent("\(hinarios.music)")
	...
	func playingSong() {
		...
		let fileURL = documentsDirectoryURL.appendingPathComponent("\(hinarios.music)")
	...
	func gerarUrlmusicSalvaLocal() {
		...
		//			let musicRef = storage.child("music/\(hinarios.music)")
	...
	fileprivate func setupTopControls() {
		...
		if #available(iOS 11.0, *) {
			...
			viewWebView.bottomAnchor.constraint(equalTo: view.bottomAnchor, constant: 5).isActive = true
		...
		if #available(iOS 11.0, *) {
			...
			myWebView.bottomAnchor.constraint(equalTo: viewWebView.bottomAnchor, constant: 5).isActive = true
	...
	@objc private func handleControlsPainel() {
		if allStackViewAreasLayout.isHidden {
			...
			//			//Ver por não atualiza o banco de dados para pdoer tocar
			//			if hinarios.musicURL == nil || hinarios.musicURL == " " {
			//				print("Sem URL DE MUSICA PARA TOCAR")
			//			} else {
			//				let musicURLonline = hinarios.musicURL
			//				let urlMusic = NSURL(string: musicURLonline!)
			//				downloadFileFromURL(url: urlMusic!)
			//			}
	...
	func downloadImagemWebView() {
		...
		if !FileManager.default.fileExists(atPath: fileURL.path) {
			...
			case 1...2:
				...
				let html = "<!doctype html><head><meta charset=\"UTF-8\"><title>Hinário Adventista do 7º Dia</title><link href=\"style.css\" rel=\"stylesheet\" type=\"text/css\"><body style=\"font-size:\(currentValueSlider)vw;font-family:\(currentValueFont);background-color:\(currentColorBack);\"><div class=\"container clearfix\"><div id=\"imagem-topo\" style=\"outline:none;\"><img class=\"img-class\" src=\"semImagem.jpg\"/><h1 class=\"heading\">\(hinarios.number + " - " + hinarios.name)</h1><h4 class=\"authing\">\(hinarios.compositor)</h4></div><div id=\"estrofe-prim\"><h3>1ª Estrofe</h3><p class=\"content\">\(hinarios.estrofeUm)</p></div><div id=\"estrofe-segun\"><h3>2ª Estrofe</h3><p class=\"content\">\(hinarios.estrofeDois)</p></div></div></body></html>"
			...
			case 1...3:
				...
				let html = "<!doctype html><head><meta charset=\"UTF-8\"><title>Hinário Adventista do 7º Dia</title><link href=\"style.css\" rel=\"stylesheet\" type=\"text/css\"><body style=\"font-size:\(currentValueSlider)vw;font-family:\(currentValueFont);background-color:\(currentColorBack);\"><div class=\"container clearfix\"><div id=\"imagem-topo\" style=\"outline:none;\"><img class=\"img-class\" src=\"semImagem.jpg\"/><h1 class=\"heading\">\(hinarios.number + " - " + hinarios.name)</h1><h4 class=\"authing\">\(hinarios.compositor)</h4></div><div id=\"estrofe-prim\"><h3>1ª Estrofe</h3><p class=\"content\">\(hinarios.estrofeUm)</p></div><div id=\"estrofe-segun\"><h3>2ª Estrofe</h3><p class=\"content\">\(hinarios.estrofeDois)</p></div><div id=\"estrofe-terc\"><h3>3ª Estrofe</h3><p class=\"content\">\(hinarios.estrofeTres)</p></div></div></body></html>"
			...
			case 1...4:
				...
				let html = "<!doctype html><head><meta charset=\"UTF-8\"><title>Hinário Adventista do 7º Dia</title><link href=\"style.css\" rel=\"stylesheet\" type=\"text/css\"><body style=\"font-size:\(currentValueSlider)vw;font-family:\(currentValueFont);background-color:\(currentColorBack);\"><div class=\"container clearfix\"><div id=\"imagem-topo\" style=\"outline:none;\"><img class=\"img-class\" src=\"semImagem.jpg\"/><h1 class=\"heading\">\(hinarios.number + " - " + hinarios.name)</h1><h4 class=\"authing\">\(hinarios.compositor)</h4></div><div id=\"estrofe-prim\"><h3>1ª Estrofe</h3><p class=\"content\">\(hinarios.estrofeUm)</p></div><div id=\"estrofe-segun\"><h3>2ª Estrofe</h3><p class=\"content\">\(hinarios.estrofeDois)</p><div id=\"estrofe-terc\"><h3>3ª Estrofe</h3><p class=\"content\">\(hinarios.estrofeTres)</p></div><div id=\"estrofe-quart\"><h3>4ª Estrofe</h3><p class=\"content\">\(hinarios.estrofeQuatro)</p></div></div></body></html>"
			...
			case 1...5:
				...
				let html = "<!doctype html><head><meta charset=\"UTF-8\"><title>Hinário Adventista do 7º Dia</title><link href=\"style.css\" rel=\"stylesheet\" type=\"text/css\"><body style=\"font-size:\(currentValueSlider)vw;font-family:\(currentValueFont);background-color:\(currentColorBack);\"><div class=\"container clearfix\"><div id=\"imagem-topo\" style=\"outline:none;\"><img class=\"img-class\" src=\"semImagem.jpg\"/><h1 class=\"heading\">\(hinarios.number + " - " + hinarios.name)</h1><h4 class=\"authing\">\(hinarios.compositor)</h4></div><div id=\"estrofe-prim\"><h3>1ª Estrofe</h3><p class=\"content\">\(hinarios.estrofeUm)</p></div><div id=\"estrofe-segun\"><h3>2ª Estrofe</h3><p class=\"content\">\(hinarios.estrofeDois)</p></div><div id=\"estrofe-terc\"><h3>3ª Estrofe</h3><p class=\"content\">\(hinarios.estrofeTres)</p></div><div id=\"estrofe-quart\"><h3>4ª Estrofe</h3><p class=\"content\">\(hinarios.estrofeQuatro)</p></div><div id=\"estrofe-quin\"><h3>5ª Estrofe</h3><p class=\"content\">\(hinarios.estrofeCinco)</p></div></div></body></html>"
			...
			case 1...6:
				...
				let html = "<!doctype html><head><meta charset=\"UTF-8\"><title>Hinário Adventista do 7º Dia</title><link href=\"style.css\" rel=\"stylesheet\" type=\"text/css\"><body style=\"font-size:\(currentValueSlider)vw;font-family:\(currentValueFont);background-color:\(currentColorBack);\"><div class=\"container clearfix\"><div id=\"imagem-topo\" style=\"outline:none;\"><img class=\"img-class\" src=\"semImagem.jpg\"/><h1 class=\"heading\">\(hinarios.number + " - " + hinarios.name)</h1><h4 class=\"authing\">\(hinarios.compositor)</h4></div><div id=\"estrofe-prim\"><h3>1ª Estrofe</h3><p class=\"content\">\(hinarios.estrofeUm)</p></div><div id=\"coro\"><h3>Coro</h3><p class=\"content\">\(hinarios.estrofeCoroNormal)</p></div><div id=\"estrofe-segun\"><h3>2ª Estrofe</h3><p class=\"content\">\(hinarios.estrofeDois)</p></div><div id=\"coro\"><h3>Coro</h3><p class=\"content\">\(hinarios.estrofeCoroNormal)</p></div><div id=\"estrofe-terc\"><h3>3ª Estrofe</h3><p class=\"content\">\(hinarios.estrofeTres)</p></div><div id=\"coro\"><h3>Coro</h3><p class=\"content\">\(hinarios.estrofeCoroNormal)</p></div></div></body></html>"
			...
			case 1...7:
				...
				let html = "<!doctype html><head><meta charset=\"UTF-8\"><title>Hinário Adventista do 7º Dia</title><link href=\"style.css\" rel=\"stylesheet\" type=\"text/css\"><body style=\"font-size:\(currentValueSlider)vw;font-family:\(currentValueFont);background-color:\(currentColorBack);\"><div class=\"container clearfix\"><div id=\"imagem-topo\" style=\"outline:none;\"><img class=\"img-class\" src=\"semImagem.jpg\"/><h1 class=\"heading\">\(hinarios.number + " - " + hinarios.name)</h1><h4 class=\"authing\">\(hinarios.compositor)</h4></div><div id=\"coro\"><h3>Coro</h3><p class=\"content\">\(hinarios.estrofeCoroInicio)</p></div><div id=\"estrofe-prim\"><h3>1ª Estrofe</h3><p class=\"content\">\(hinarios.estrofeUm)</p></div><div id=\"coro\"><h3>Coro</h3><p class=\"content\">\(hinarios.estrofeCoroInicio)</p></div><div id=\"estrofe-segun\"><h3>2ª Estrofe</h3><p class=\"content\">\(hinarios.estrofeDois)</p></div><div id=\"coro\"><h3>Coro</h3><p class=\"content\">\(hinarios.estrofeCoroInicio)</p></div><div id=\"estrofe-terc\"><h3>3ª Estrofe</h3><p class=\"content\">\(hinarios.estrofeTres)</p></div><div id=\"coro\"><h3>Coro</h3><p class=\"content\">\(hinarios.estrofeCoroInicio)</p></div></div></body></html>"
			...
			case 1...8:
				...
				let html = "<!doctype html><head><meta charset=\"UTF-8\"><title>Hinário Adventista do 7º Dia</title><link href=\"style.css\" rel=\"stylesheet\" type=\"text/css\"><body style=\"font-size:\(currentValueSlider)vw;font-family:\(currentValueFont);background-color:\(currentColorBack);\"><div class=\"container clearfix\"><div id=\"imagem-topo\" style=\"outline:none;\"><img class=\"img-class\" src=\"semImagem.jpg\"/><h1 class=\"heading\">\(hinarios.number + " - " + hinarios.name)</h1><h4 class=\"authing\">\(hinarios.compositor)</h4></div><div id=\"estrofe-prim\"><h3>1ª Estrofe</h3><p class=\"content\">\(hinarios.estrofeUm)</p></div><div id=\"coro\"><h3>Coro</h3><p class=\"content\">\(hinarios.estrofeCoroNormal)</p></div><div id=\"estrofe-segun\"><h3>2ª Estrofe</h3><p class=\"content\">\(hinarios.estrofeDois)</p></div><div id=\"coro\"><h3>Coro</h3><p class=\"content\">\(hinarios.estrofeCoroNormal)</p></div><div id=\"estrofe-terc\"><h3>3ª Estrofe</h3><p class=\"content\">\(hinarios.estrofeTres)</p></div><div id=\"coro\"><h3>Coro</h3><p class=\"content\">\(hinarios.estrofeCoroNormal)</p></div><div id=\"estrofe-quart\"><h3>4ª Estrofe</h3><p class=\"content\">\(hinarios.estrofeQuatro)</p></div><div id=\"coro\"><h3>Coro</h3><p class=\"content\">\(hinarios.estrofeCoroNormal)</p></div></div></body></html>"
			...
			case 1...9:
				...
				let html = "<!doctype html><head><meta charset=\"UTF-8\"><title>Hinário Adventista do 7º Dia</title><link href=\"style.css\" rel=\"stylesheet\" type=\"text/css\"><body style=\"font-size:\(currentValueSlider)vw;font-family:\(currentValueFont);background-color:\(currentColorBack);\"><div class=\"container clearfix\"><div id=\"imagem-topo\" style=\"outline:none;\"><img class=\"img-class\" src=\"semImagem.jpg\"/><h1 class=\"heading\">\(hinarios.number + " - " + hinarios.name)</h1><h4 class=\"authing\">\(hinarios.compositor)</h4></div><div id=\"coro\"><h3>Coro</h3><p class=\"content\">\(hinarios.estrofeCoroInicio)</p></div><div id=\"estrofe-prim\"><h3>1ª Estrofe</h3><p class=\"content\">\(hinarios.estrofeUm)</p></div><div id=\"coro\"><h3>Coro</h3><p class=\"content\">\(hinarios.estrofeCoroInicio)</p></div><div id=\"estrofe-segun\"><h3>2ª Estrofe</h3><p class=\"content\">\(hinarios.estrofeDois)</p></div><div id=\"coro\"><h3>Coro</h3><p class=\"content\">\(hinarios.estrofeCoroInicio)</p></div><div id=\"estrofe-terc\"><h3>3ª Estrofe</h3><p class=\"content\">\(hinarios.estrofeTres)</p></div><div id=\"coro\"><h3>Coro</h3><p class=\"content\">\(hinarios.estrofeCoroInicio)</p></div><div id=\"estrofe-quart\"><h3>4ª Estrofe</h3><p class=\"content\">\(hinarios.estrofeQuatro)</p></div><div id=\"coro\"><h3>Coro</h3><p class=\"content\">\(hinarios.estrofeCoroInicio)</p></div></div></body></html>"
			...
			case 1...10:
				...
				let html = "<!doctype html><head><meta charset=\"UTF-8\"><title>Hinário Adventista do 7º Dia</title><link href=\"style.css\" rel=\"stylesheet\" type=\"text/css\"><body style=\"font-size:\(currentValueSlider)vw;font-family:\(currentValueFont);background-color:\(currentColorBack);\"><div class=\"container clearfix\"><div id=\"imagem-topo\" style=\"outline:none;\"><img class=\"img-class\" src=\"semImagem.jpg\"/><h1 class=\"heading\">\(hinarios.number + " - " + hinarios.name)</h1><h4 class=\"authing\">\(hinarios.compositor)</h4></div><div id=\"estrofe-prim\"><h3>1ª Estrofe</h3><p class=\"content\">\(hinarios.estrofeUm)</p></div><div id=\"coro\"><h3>Coro</h3><p class=\"content\">\(hinarios.estrofeCoroNormal)</p></div><div id=\"estrofe-segun\"><h3>2ª Estrofe</h3><p class=\"content\">\(hinarios.estrofeDois)</p></div><div id=\"coro\"><h3>Coro</h3><p class=\"content\">\(hinarios.estrofeCoroNormal)</p></div></div></body></html>"
			...
			case 1...11:
				...
				let html = "<!doctype html><head><meta charset=\"UTF-8\"><title>Hinário Adventista do 7º Dia</title><link href=\"style.css\" rel=\"stylesheet\" type=\"text/css\"><body style=\"font-size:\(currentValueSlider)vw;font-family:\(currentValueFont);background-color:\(currentColorBack);\"><div class=\"container clearfix\"><div id=\"imagem-topo\" style=\"outline:none;\"><img class=\"img-class\" src=\"semImagem.jpg\"/><h1 class=\"heading\">\(hinarios.number + " - " + hinarios.name)</h1><h4 class=\"authing\">\(hinarios.compositor)</h4></div><div id=\"coro\"><h3>Coro</h3><p class=\"content\">\(hinarios.estrofeCoroInicio)</p></div><div id=\"estrofe-prim\"><h3>1ª Estrofe</h3><p class=\"content\">\(hinarios.estrofeUm)</p></div><div id=\"coro\"><h3>Coro</h3><p class=\"content\">\(hinarios.estrofeCoroInicio)</p></div><div id=\"estrofe-segun\"><h3>2ª Estrofe</h3><p class=\"content\">\(hinarios.estrofeDois)</p></div><div id=\"coro\"><h3>Coro</h3><p class=\"content\">\(hinarios.estrofeCoroInicio)</p></div></div></body></html>"
			...
			case 1...12:
				...
				let html = "<!doctype html><head><meta charset=\"UTF-8\"><title>Hinário Adventista do 7º Dia</title><link href=\"style.css\" rel=\"stylesheet\" type=\"text/css\"><body style=\"font-size:\(currentValueSlider)vw;font-family:\(currentValueFont);background-color:\(currentColorBack);\"><div class=\"container clearfix\"><div id=\"imagem-topo\" style=\"outline:none;\"><img class=\"img-class\" src=\"semImagem.jpg\"/><h1 class=\"heading\">\(hinarios.number + " - " + hinarios.name)</h1><h4 class=\"authing\">\(hinarios.compositor)</h4></div><div id=\"estrofe-prim\"><h3>1ª Estrofe</h3><p class=\"content\">\(hinarios.estrofeUm)</p></div><div id=\"coro\"><h3>Coro</h3><p class=\"content\">\(hinarios.estrofeCoroNormal)</p></div></div></body></html>"
			...
			case 1...13:
				...
				let html = "<!doctype html><head><meta charset=\"UTF-8\"><title>Hinário Adventista do 7º Dia</title><link href=\"style.css\" rel=\"stylesheet\" type=\"text/css\"><body style=\"font-size:\(currentValueSlider)vw;font-family:\(currentValueFont);background-color:\(currentColorBack);\"><div class=\"container clearfix\"><div id=\"imagem-topo\" style=\"outline:none;\"><img class=\"img-class\" src=\"semImagem.jpg\"/><h1 class=\"heading\">\(hinarios.number + " - " + hinarios.name)</h1><h4 class=\"authing\">\(hinarios.compositor)</h4></div><div id=\"coro\"><h3>Coro</h3><p class=\"content\">\(hinarios.estrofeCoroInicio)</p></div><div id=\"estrofe-prim\"><h3>1ª Estrofe</h3><p class=\"content\">\(hinarios.estrofeUm)</p></div><div id=\"coro\"><h3>Coro</h3><p class=\"content\">\(hinarios.estrofeCoroInicio)</p></div></div></body></html>"
			...
			case 1...14:
				...
				let html = "<!doctype html><head><meta charset=\"UTF-8\"><title>Hinário Adventista do 7º Dia</title><link href=\"style.css\" rel=\"stylesheet\" type=\"text/css\"><body style=\"font-size:\(currentValueSlider)vw;font-family:\(currentValueFont);background-color:\(currentColorBack);\"><div class=\"container clearfix\"><div id=\"imagem-topo\" style=\"outline:none;\"><img class=\"img-class\" src=\"semImagem.jpg\"/><h1 class=\"heading\">\(hinarios.number + " - " + hinarios.name)</h1><h4 class=\"authing\">\(hinarios.compositor)</h4></div><div id=\"estrofe-prim\"><h3>1ª Estrofe</h3><p class=\"content\">\(hinarios.estrofeUm)</p></div><div id=\"coro\"><h3>Coro</h3><p class=\"content\">\(hinarios.estrofeCoroNormal)</p></div><div id=\"estrofe-segun\"><h3>2ª Estrofe</h3><p class=\"content\">\(hinarios.estrofeDois)</p></div><div id=\"coro\"><h3>Coro</h3><p class=\"content\">\(hinarios.estrofeCoroNormal)</p></div><div id=\"estrofe-terc\"><h3>3ª Estrofe</h3><p class=\"content\">\(hinarios.estrofeTres)</p></div><div id=\"coro\"><h3>Coro</h3><p class=\"content\">\(hinarios.estrofeCoroNormal)</p></div><div id=\"estrofe-quart\"><h3>4ª Estrofe</h3><p class=\"content\">\(hinarios.estrofeQuatro)</p></div><div id=\"coro\"><h3>Coro</h3><p class=\"content\">\(hinarios.estrofeCoroNormal)</p></div><div id=\"estrofe-quin\"><h3>5ª Estrofe</h3><p class=\"content\">\(hinarios.estrofeCinco)</p></div><div id=\"coro\"><h3>Coro</h3><p class=\"content\">\(hinarios.estrofeCoroNormal)</p></div></div></body></html>"
			...
			case 1...15:
				...
				let html = "<!doctype html><head><meta charset=\"UTF-8\"><title>Hinário Adventista do 7º Dia</title><link href=\"style.css\" rel=\"stylesheet\" type=\"text/css\"><body style=\"font-size:\(currentValueSlider)vw;font-family:\(currentValueFont);background-color:\(currentColorBack);\"><div class=\"container clearfix\"><div id=\"imagem-topo\" style=\"outline:none;\"><img class=\"img-class\" src=\"semImagem.jpg\"/><h1 class=\"heading\">\(hinarios.number + " - " + hinarios.name)</h1><h4 class=\"authing\">\(hinarios.compositor)</h4></div><div id=\"coro\"><h3>Coro</h3><p class=\"content\">\(hinarios.estrofeCoroInicio)</p></div><div id=\"estrofe-prim\"><h3>1ª Estrofe</h3><p class=\"content\">\(hinarios.estrofeUm)</p></div><div id=\"coro\"><h3>Coro</h3><p class=\"content\">\(hinarios.estrofeCoroInicio)</p></div><div id=\"estrofe-segun\"><h3>2ª Estrofe</h3><p class=\"content\">\(hinarios.estrofeDois)</p></div><div id=\"coro\"><h3>Coro</h3><p class=\"content\">\(hinarios.estrofeCoroInicio)</p></div><div id=\"estrofe-terc\"><h3>3ª Estrofe</h3><p class=\"content\">\(hinarios.estrofeTres)</p></div><div id=\"coro\"><h3>Coro</h3><p class=\"content\">\(hinarios.estrofeCoroInicio)</p></div><div id=\"estrofe-quart\"><h3>4ª Estrofe</h3><p class=\"content\">\(hinarios.estrofeQuatro)</p></div><div id=\"coro\"><h3>Coro</h3><p class=\"content\">\(hinarios.estrofeCoroInicio)</p></div><div id=\"estrofe-quin\"><h3>5ª Estrofe</h3><p class=\"content\">\(hinarios.estrofeCinco)</p></div><div id=\"coro\"><h3>Coro</h3><p class=\"content\">\(hinarios.estrofeCoroInicio)</p></div></div></body></html>"
			...
			default:
				...
				let html = "<!doctype html><head><meta charset=\"UTF-8\"><title>Hinário Adventista do 7º Dia</title><link href=\"style.css\" rel=\"stylesheet\" type=\"text/css\"><body style=\"font-size:\(currentValueSlider)vw;font-family:\(currentValueFont);background-color:\(currentColorBack);\"><div class=\"container clearfix\"><div id=\"imagem-topo\" style=\"outline:none;\"><img class=\"img-class\" src=\"semImagem.jpg\"/><h1 class=\"heading\">\(hinarios.number + " - " + hinarios.name)</h1><h4 class=\"authing\">\(hinarios.compositor)</h4></div><div id=\"coro\"><h3>Coro</h3><p class=\"content\">\(hinarios.estrofeCoroInicio)</p></div></div></body></html>"
			...
			case 1...1:
				...
				let html = "<!doctype html><head><meta charset=\"UTF-8\"><title>Hinário Adventista do 7º Dia</title><link href=\"style.css\" rel=\"stylesheet\" type=\"text/css\"><body style=\"font-size:\(currentValueSlider)vw;font-family:\(currentValueFont);background-color:\(currentColorBack);\"><div class=\"container clearfix\"><div id=\"imagem-topo\" style=\"outline:none;\"><img class=\"img-class\" src='\(fileURL.path)'/><h1 class=\"heading\">\(hinarios.number + " - " + hinarios.name)</h1><h4 class=\"authing\">\(hinarios.compositor)</h4></div><div id=\"estrofe-prim\"><h3>1ª Estrofe</h3><p class=\"content\">\(hinarios.estrofeUm)</p></div></div></body></html>"
			...
			case 1...2:
				...
				let html = "<!doctype html><head><meta charset=\"UTF-8\"><title>Hinário Adventista do 7º Dia</title><link href=\"style.css\" rel=\"stylesheet\" type=\"text/css\"><body style=\"font-size:\(currentValueSlider)vw;font-family:\(currentValueFont);background-color:\(currentColorBack);\"><div class=\"container clearfix\"><div id=\"imagem-topo\" style=\"outline:none;\"><img class=\"img-class\" src='\(fileURL.path)'/><h1 class=\"heading\">\(hinarios.number + " - " + hinarios.name)</h1><h4 class=\"authing\">\(hinarios.compositor)</h4></div><div id=\"estrofe-prim\"><h3>1ª Estrofe</h3><p class=\"content\">\(hinarios.estrofeUm)</p></div><div id=\"estrofe-segun\"><h3>2ª Estrofe</h3><p class=\"content\">\(hinarios.estrofeDois)</p></div></div></body></html>"
			...
			case 1...3:
				...
				let html = "<!doctype html><head><meta charset=\"UTF-8\"><title>Hinário Adventista do 7º Dia</title><link href=\"style.css\" rel=\"stylesheet\" type=\"text/css\"></head><body style=\"font-size:\(currentValueSlider)vw;font-family:\(currentValueFont);background-color:\(currentColorBack);\"><div class=\"container clearfix\"><div id=\"imagem-topo\" style=\"outline:none;\"><img class=\"img-class\" src='\(fileURL.path)'/><h1 class=\"heading\">\(hinarios.number + " - " + hinarios.name)</h1><h4 class=\"authing\">\(hinarios.compositor)</h4></div><div id=\"estrofe-prim\"><h3>1ª Estrofe</h3><p class=\"content\">\(hinarios.estrofeUm)</p></div><div id=\"estrofe-segun\"><h3>2ª Estrofe</h3><p class=\"content\">\(hinarios.estrofeDois)</p></div><div id=\"estrofe-terc\"><h3>3ª Estrofe</h3><p class=\"content\">\(hinarios.estrofeTres)</p></div></div></body></html>"
			...
			case 1...4:
				...
				let html = "<!doctype html><head><meta charset=\"UTF-8\"><title>Hinário Adventista do 7º Dia</title><link href=\"style.css\" rel=\"stylesheet\" type=\"text/css\"><body style=\"font-size:\(currentValueSlider)vw;font-family:\(currentValueFont);background-color:\(currentColorBack);\"><div class=\"container clearfix\"><div id=\"imagem-topo\" style=\"outline:none;\"><img class=\"img-class\" src='\(fileURL.path)'/><h1 class=\"heading\">\(hinarios.number + " - " + hinarios.name)</h1><h4 class=\"authing\">\(hinarios.compositor)</h4></div><div id=\"estrofe-prim\"><h3>1ª Estrofe</h3><p class=\"content\">\(hinarios.estrofeUm)</p></div><div id=\"estrofe-segun\"><h3>2ª Estrofe</h3><p class=\"content\">\(hinarios.estrofeDois)</p><div id=\"estrofe-terc\"><h3>3ª Estrofe</h3><p class=\"content\">\(hinarios.estrofeTres)</p></div><div id=\"estrofe-quart\"><h3>4ª Estrofe</h3><p class=\"content\">\(hinarios.estrofeQuatro)</p></div></div></body></html>"
			...
			case 1...6:
				...
				let html = "<!doctype html><head><meta charset=\"UTF-8\"><title>Hinário Adventista do 7º Dia</title><link href=\"style.css\" rel=\"stylesheet\" type=\"text/css\"><body style=\"font-size:\(currentValueSlider)vw;font-family:\(currentValueFont);background-color:\(currentColorBack);\"><div class=\"container clearfix\"><div id=\"imagem-topo\" style=\"outline:none;\"><img class=\"img-class\" src='\(fileURL.path)'/><h1 class=\"heading\">\(hinarios.number + " - " + hinarios.name)</h1><h4 class=\"authing\">\(hinarios.compositor)</h4></div><div id=\"estrofe-prim\"><h3>1ª Estrofe</h3><p class=\"content\">\(hinarios.estrofeUm)</p></div><div id=\"coro\"><h3>Coro</h3><p class=\"content\">\(hinarios.estrofeCoroNormal)</p></div><div id=\"estrofe-segun\"><h3>2ª Estrofe</h3><p class=\"content\">\(hinarios.estrofeDois)</p></div><div id=\"coro\"><h3>Coro</h3><p class=\"content\">\(hinarios.estrofeCoroNormal)</p></div><div id=\"estrofe-terc\"><h3>3ª Estrofe</h3><p class=\"content\">\(hinarios.estrofeTres)</p></div><div id=\"coro\"><h3>Coro</h3><p class=\"content\">\(hinarios.estrofeCoroNormal)</p></div></div></body></html>"
			...
			case 1...7:
				...
				let html = "<!doctype html><head><meta charset=\"UTF-8\"><title>Hinário Adventista do 7º Dia</title><link href=\"style.css\" rel=\"stylesheet\" type=\"text/css\"><body style=\"font-size:\(currentValueSlider)vw;font-family:\(currentValueFont);background-color:\(currentColorBack);\"><div class=\"container clearfix\"><div id=\"imagem-topo\" style=\"outline:none;\"><img class=\"img-class\" src='\(fileURL.path)'/><h1 class=\"heading\">\(hinarios.number + " - " + hinarios.name)</h1><h4 class=\"authing\">\(hinarios.compositor)</h4></div><div id=\"coro\"><h3>Coro</h3><p class=\"content\">\(hinarios.estrofeCoroInicio)</p></div><div id=\"estrofe-prim\"><h3>1ª Estrofe</h3><p class=\"content\">\(hinarios.estrofeUm)</p></div><div id=\"coro\"><h3>Coro</h3><p class=\"content\">\(hinarios.estrofeCoroInicio)</p></div><div id=\"estrofe-segun\"><h3>2ª Estrofe</h3><p class=\"content\">\(hinarios.estrofeDois)</p></div><div id=\"coro\"><h3>Coro</h3><p class=\"content\">\(hinarios.estrofeCoroInicio)</p></div><div id=\"estrofe-terc\"><h3>3ª Estrofe</h3><p class=\"content\">\(hinarios.estrofeTres)</p></div><div id=\"coro\"><h3>Coro</h3><p class=\"content\">\(hinarios.estrofeCoroInicio)</p></div></div></body></html>"
			...
			case 1...10:
				...
				let html = "<!doctype html><head><meta charset=\"UTF-8\"><title>Hinário Adventista do 7º Dia</title><link href=\"style.css\" rel=\"stylesheet\" type=\"text/css\"><body style=\"font-size:\(currentValueSlider)vw;font-family:\(currentValueFont);background-color:\(currentColorBack);\"><div class=\"container clearfix\"><div id=\"imagem-topo\" style=\"outline:none;\"><img class=\"img-class\" src='\(fileURL.path)'/><h1 class=\"heading\">\(hinarios.number + " - " + hinarios.name)</h1><h4 class=\"authing\">\(hinarios.compositor)</h4></div><div id=\"estrofe-prim\"><h3>1ª Estrofe</h3><p class=\"content\">\(hinarios.estrofeUm)</p></div><div id=\"coro\"><h3>Coro</h3><p class=\"content\">\(hinarios.estrofeCoroNormal)</p></div><div id=\"estrofe-segun\"><h3>2ª Estrofe</h3><p class=\"content\">\(hinarios.estrofeDois)</p></div><div id=\"coro\"><h3>Coro</h3><p class=\"content\">\(hinarios.estrofeCoroNormal)</p></div></div></body></html>"
			...
			case 1...11:
				...
				let html = "<!doctype html><head><meta charset=\"UTF-8\"><title>Hinário Adventista do 7º Dia</title><link href=\"style.css\" rel=\"stylesheet\" type=\"text/css\"><body style=\"font-size:\(currentValueSlider)vw;font-family:\(currentValueFont);background-color:\(currentColorBack);\"><div class=\"container clearfix\"><div id=\"imagem-topo\" style=\"outline:none;\"><img class=\"img-class\" src='\(fileURL.path)'/><h1 class=\"heading\">\(hinarios.number + " - " + hinarios.name)</h1><h4 class=\"authing\">\(hinarios.compositor)</h4></div><div id=\"coro\"><h3>Coro</h3><p class=\"content\">\(hinarios.estrofeCoroInicio)</p></div><div id=\"estrofe-prim\"><h3>1ª Estrofe</h3><p class=\"content\">\(hinarios.estrofeUm)</p></div><div id=\"coro\"><h3>Coro</h3><p class=\"content\">\(hinarios.estrofeCoroInicio)</p></div><div id=\"estrofe-segun\"><h3>2ª Estrofe</h3><p class=\"content\">\(hinarios.estrofeDois)</p></div><div id=\"coro\"><h3>Coro</h3><p class=\"content\">\(hinarios.estrofeCoroInicio)</p></div></div></body></html>"
			...
			case 1...12:
				...
				let html = "<!doctype html><head><meta charset=\"UTF-8\"><title>Hinário Adventista do 7º Dia</title><link href=\"style.css\" rel=\"stylesheet\" type=\"text/css\"><body style=\"font-size:\(currentValueSlider)vw;font-family:\(currentValueFont);background-color:\(currentColorBack);\"><div class=\"container clearfix\"><div id=\"imagem-topo\" style=\"outline:none;\"><img class=\"img-class\" src='\(fileURL.path)'/><h1 class=\"heading\">\(hinarios.number + " - " + hinarios.name)</h1><h4 class=\"authing\">\(hinarios.compositor)</h4></div><div id=\"estrofe-prim\"><h3>1ª Estrofe</h3><p class=\"content\">\(hinarios.estrofeUm)</p></div><div id=\"coro\"><h3>Coro</h3><p class=\"content\">\(hinarios.estrofeCoroNormal)</p></div></div></body></html>"
			...
			case 1...13:
				...
				let html = "<!doctype html><head><meta charset=\"UTF-8\"><title>Hinário Adventista do 7º Dia</title><link href=\"style.css\" rel=\"stylesheet\" type=\"text/css\"><body style=\"font-size:\(currentValueSlider)vw;font-family:\(currentValueFont);background-color:\(currentColorBack);\"><div class=\"container clearfix\"><div id=\"imagem-topo\" style=\"outline:none;\"><img class=\"img-class\" src='\(fileURL.path)'/><h1 class=\"heading\">\(hinarios.number + " - " + hinarios.name)</h1><h4 class=\"authing\">\(hinarios.compositor)</h4></div><div id=\"coro\"><h3>Coro</h3><p class=\"content\">\(hinarios.estrofeCoroInicio)</p></div><div id=\"estrofe-prim\"><h3>1ª Estrofe</h3><p class=\"content\">\(hinarios.estrofeUm)</p></div><div id=\"coro\"><h3>Coro</h3><p class=\"content\">\(hinarios.estrofeCoroInicio)</p></div></div></body></html>"
			...
			default:
				...
				let html = "<!doctype html><head><meta charset=\"UTF-8\"><title>Hinário Adventista do 7º Dia</title><link href=\"style.css\" rel=\"stylesheet\" type=\"text/css\"><body style=\"font-size:\(currentValueSlider)vw;font-family:\(currentValueFont);background-color:\(currentColorBack);\"><div class=\"container clearfix\"><div id=\"imagem-topo\" style=\"outline:none;\"><img class=\"img-class\" src='\(fileURL.path)'/><h1 class=\"heading\">\(hinarios.number + " - " + hinarios.name)</h1><h4 class=\"authing\">\(hinarios.compositor)</h4></div><div id=\"coro\"><h3>Coro</h3><p class=\"content\">\(hinarios.estrofeCoroInicio)</p></div></div></body></html>"
