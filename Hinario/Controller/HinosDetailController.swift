//
//  HinosDetailController.swift
//  Hinário
//
//  Created by Ewerson Castelo on 09/01/2018.
...
//	let reachability = Reachability()
	...
	override func viewDidLoad() {
		...
		navigationItem.title = (hinarios.name)
		...
		//Gera URL das musicas para salvar localmente
		gerarUrlmusicSalvaLocal()
	...
	func verificaEstadoBotaoFavorito(){
		if(verificaFavorito(idName: "\(String(describing: (hinarios.name)))")){
	...
	func salvarDados(listafavoritos:[Favorito]){
		...
		var listaRefHino:[String] = [] //DatabaseReference?
	...
	@objc private func handleFavoritar() {
		...
		if(favoritado) {
			...
			let novoFavorito:Favorito = Favorito(nameFav: hinarios!.name, numberFav: hinarios!.number, authFav: hinarios!.compositor, musicFav: hinarios!.music, musicUrlFav: hinarios!.musicURL!, estrofeUmFav: hinarios!.estrofeUm, estrofeDoisFav: hinarios!.estrofeDois, estrofeTresFav: hinarios!.estrofeTres, estrofeQuatroFav: hinarios!.estrofeQuatro, estrofeCincoFav: hinarios!.estrofeCinco, estrofeCoroNormalFav: hinarios!.estrofeCoroNormal, estrofeCoroInicioFav: hinarios!.estrofeCoroInicio, listaRefHino: "\(String(describing: hinarios.ref))!")
			
			adicionaFavoritos(favorito: novoFavorito)
			
		} else {
			buttomFavoritar.tintColor = .white
			removeFavorito(idName: (hinarios.name))
		}
	}
	...
	@objc func fazerDownload(_ sender: InAppPurchaseButton) {
		...
		let filePath = path.appendingPathComponent("\(String(describing: hinarios.music))")
		...
		if (hinarios.musicURL == nil || hinarios.musicURL == "") {
			...
			let musicDownRef = storage.child("music/\(String(describing: hinarios.music))")
	...
	func statusDownloadMusic() {
		...
		let filePathIcon = pathIcon.appendingPathComponent("\(String(describing: hinarios.music))")
	...
	func playingSong() {
		...
		let fileURL = documentsDirectoryURL.appendingPathComponent("\(String(describing: hinarios.music))")
...
//	}
	...
	//Monta o LINK das MUSICAS do Storage e disponibiliza em URL válida acessível
	func gerarUrlmusicSalvaLocal() {
		
		if (hinarios.musicURL == nil || hinarios.musicURL == "") {
			print("URL Da Musica não Criada")
			let musicRef = storage.child("music/\(String(describing: hinarios.music))")
			...
			print("URL da musica já foi Criada")
		}
	}
	...
	fileprivate func setupTopControls() {
		...
		if #available(iOS 11.0, *) {
			...
			myWebView.bottomAnchor.constraint(equalTo: viewWebView.safeAreaLayoutGuide.bottomAnchor, constant: 0).isActive = true
	...
	func downloadImagemWebView() {
		...
		let fileURL = documentsDirectoryURL.appendingPathComponent("\(String(describing: hinarios.image))")
		...
		if !FileManager.default.fileExists(atPath: fileURL.path) {
			...
			if hinarios.estrofeUm == "nil" {
				quantidadeEstrofe = 0
			} else if hinarios.estrofeDois == "nil" && hinarios.estrofeCoroNormal == "nil" && hinarios.estrofeCoroInicio == "nil" {
				quantidadeEstrofe = 1 //-----começa aqui-------------------------------------------------------------------------------------
			} else if hinarios.estrofeDois == "nil" && hinarios.estrofeCoroNormal != "nil" {
				quantidadeEstrofe = 12
			} else if hinarios.estrofeDois == "nil" && hinarios.estrofeCoroInicio != "nil" {
				quantidadeEstrofe = 13
			} else if hinarios.estrofeTres == "nil" && hinarios.estrofeCoroNormal == "nil" && hinarios.estrofeCoroInicio == "nil" {
				quantidadeEstrofe = 2 //-----começa aqui-------------------------------------------------------------------------------------
			} else if hinarios.estrofeTres == "nil" && hinarios.estrofeCoroNormal != "nil" {
				quantidadeEstrofe = 10
			} else if hinarios.estrofeTres == "nil" && hinarios.estrofeCoroInicio != "nil" {
				quantidadeEstrofe = 11
			} else if hinarios.estrofeQuatro == "nil" && hinarios.estrofeCoroNormal == "nil" && hinarios.estrofeCoroInicio == "nil" {
				quantidadeEstrofe = 3 //-----começa aqui-------------------------------------------------------------------------------------
			} else if hinarios.estrofeQuatro == "nil" && hinarios.estrofeCoroNormal != "nil" {
				quantidadeEstrofe = 6
			} else if hinarios.estrofeQuatro == "nil" && hinarios.estrofeCoroInicio != "nil" {
				quantidadeEstrofe = 7
			} else if hinarios.estrofeCinco == "nil" && hinarios.estrofeCoroNormal == "nil" && hinarios.estrofeCoroInicio == "nil" {
				quantidadeEstrofe = 4 //-----começa aqui-------------------------------------------------------------------------------------
			} else if hinarios.estrofeCinco == "nil" && hinarios.estrofeCoroNormal != "nil" {
				quantidadeEstrofe = 8
			} else if hinarios.estrofeCinco == "nil" && hinarios.estrofeCoroInicio != "nil" {
				quantidadeEstrofe = 9
			} else if hinarios.estrofeCinco != "nil" && hinarios.estrofeCoroNormal != "nil" {
			...
			case 1...2:
				...
				let html = "<!doctype html><head><meta charset=\"UTF-8\"><title>Hinário Adventista do 7º Dia</title><link href=\"style.css\" rel=\"stylesheet\" type=\"text/css\"><body style=\"font-size:\(currentValueSlider)vw;font-family:\(currentValueFont);background-color:\(currentColorBack);\"><div class=\"container clearfix\"><div id=\"imagem-topo\" style=\"outline:none;\"><img class=\"img-class\" src=\"semImagem.jpg\"/><h1 class=\"heading\">\((hinarios.number) + " - " + (hinarios.name))</h1><h4 class=\"authing\">\(String(describing: hinarios.compositor))</h4></div><div id=\"estrofe-prim\"><h3>1ª Estrofe</h3><p class=\"content\">\(String(describing: hinarios.estrofeUm))</p></div><div id=\"estrofe-segun\"><h3>2ª Estrofe</h3><p class=\"content\">\(String(describing: hinarios.estrofeDois))</p></div></div><br/></body></html>"
			...
			case 1...3:
				...
				let html = "<!doctype html><head><meta charset=\"UTF-8\"><title>Hinário Adventista do 7º Dia</title><link href=\"style.css\" rel=\"stylesheet\" type=\"text/css\"><body style=\"font-size:\(currentValueSlider)vw;font-family:\(currentValueFont);background-color:\(currentColorBack);\"><div class=\"container clearfix\"><div id=\"imagem-topo\" style=\"outline:none;\"><img class=\"img-class\" src=\"semImagem.jpg\"/><h1 class=\"heading\">\((hinarios.number) + " - " + (hinarios.name))</h1><h4 class=\"authing\">\(String(describing: hinarios.compositor))</h4></div><div id=\"estrofe-prim\"><h3>1ª Estrofe</h3><p class=\"content\">\(String(describing: hinarios.estrofeUm))</p></div><div id=\"estrofe-segun\"><h3>2ª Estrofe</h3><p class=\"content\">\(String(describing: hinarios.estrofeDois))</p></div><div id=\"estrofe-terc\"><h3>3ª Estrofe</h3><p class=\"content\">\(String(describing: hinarios.estrofeTres))</p></div></div><br/></body></html>"
			...
			case 1...4:
				...
				let html = "<!doctype html><head><meta charset=\"UTF-8\"><title>Hinário Adventista do 7º Dia</title><link href=\"style.css\" rel=\"stylesheet\" type=\"text/css\"><body style=\"font-size:\(currentValueSlider)vw;font-family:\(currentValueFont);background-color:\(currentColorBack);\"><div class=\"container clearfix\"><div id=\"imagem-topo\" style=\"outline:none;\"><img class=\"img-class\" src=\"semImagem.jpg\"/><h1 class=\"heading\">\((hinarios.number) + " - " + (hinarios.name))</h1><h4 class=\"authing\">\(String(describing: hinarios.compositor))</h4></div><div id=\"estrofe-prim\"><h3>1ª Estrofe</h3><p class=\"content\">\(String(describing: hinarios.estrofeUm))</p></div><div id=\"estrofe-segun\"><h3>2ª Estrofe</h3><p class=\"content\">\(String(describing: hinarios.estrofeDois))</p><div id=\"estrofe-terc\"><h3>3ª Estrofe</h3><p class=\"content\">\(String(describing: hinarios.estrofeTres))</p></div><div id=\"estrofe-quart\"><h3>4ª Estrofe</h3><p class=\"content\">\(String(describing: hinarios.estrofeQuatro))</p></div></div><br/></body></html>"
			...
			case 1...5:
				...
				let html = "<!doctype html><head><meta charset=\"UTF-8\"><title>Hinário Adventista do 7º Dia</title><link href=\"style.css\" rel=\"stylesheet\" type=\"text/css\"><body style=\"font-size:\(currentValueSlider)vw;font-family:\(currentValueFont);background-color:\(currentColorBack);\"><div class=\"container clearfix\"><div id=\"imagem-topo\" style=\"outline:none;\"><img class=\"img-class\" src=\"semImagem.jpg\"/><h1 class=\"heading\">\((hinarios.number) + " - " + (hinarios.name))</h1><h4 class=\"authing\">\(String(describing: hinarios.compositor))</h4></div><div id=\"estrofe-prim\"><h3>1ª Estrofe</h3><p class=\"content\">\(String(describing: hinarios.estrofeUm))</p></div><div id=\"estrofe-segun\"><h3>2ª Estrofe</h3><p class=\"content\">\(String(describing: hinarios.estrofeDois))</p></div><div id=\"estrofe-terc\"><h3>3ª Estrofe</h3><p class=\"content\">\(String(describing: hinarios.estrofeTres))</p></div><div id=\"estrofe-quart\"><h3>4ª Estrofe</h3><p class=\"content\">\(String(describing: hinarios.estrofeQuatro))</p></div><div id=\"estrofe-quin\"><h3>5ª Estrofe</h3><p class=\"content\">\(String(describing: hinarios.estrofeCinco))</p></div></div><br/></body></html>"
			...
			case 1...6:
				...
				let html = "<!doctype html><head><meta charset=\"UTF-8\"><title>Hinário Adventista do 7º Dia</title><link href=\"style.css\" rel=\"stylesheet\" type=\"text/css\"><body style=\"font-size:\(currentValueSlider)vw;font-family:\(currentValueFont);background-color:\(currentColorBack);\"><div class=\"container clearfix\"><div id=\"imagem-topo\" style=\"outline:none;\"><img class=\"img-class\" src=\"semImagem.jpg\"/><h1 class=\"heading\">\((hinarios.number) + " - " + (hinarios.name))</h1><h4 class=\"authing\">\(String(describing: hinarios.compositor))</h4></div><div id=\"estrofe-prim\"><h3>1ª Estrofe</h3><p class=\"content\">\(String(describing: hinarios.estrofeUm))</p></div><div id=\"coro\"><h3>Coro</h3><p class=\"content\">\(String(describing: hinarios.estrofeCoroNormal))</p></div><div id=\"estrofe-segun\"><h3>2ª Estrofe</h3><p class=\"content\">\(String(describing: hinarios.estrofeDois))</p></div><div id=\"coro\"><h3>Coro</h3><p class=\"content\">\(String(describing: hinarios.estrofeCoroNormal))</p></div><div id=\"estrofe-terc\"><h3>3ª Estrofe</h3><p class=\"content\">\(String(describing: hinarios.estrofeTres))</p></div><div id=\"coro\"><h3>Coro</h3><p class=\"content\">\(String(describing: hinarios.estrofeCoroNormal))</p></div></div><br/></body></html>"
			...
			case 1...7:
				...
				let html = "<!doctype html><head><meta charset=\"UTF-8\"><title>Hinário Adventista do 7º Dia</title><link href=\"style.css\" rel=\"stylesheet\" type=\"text/css\"><body style=\"font-size:\(currentValueSlider)vw;font-family:\(currentValueFont);background-color:\(currentColorBack);\"><div class=\"container clearfix\"><div id=\"imagem-topo\" style=\"outline:none;\"><img class=\"img-class\" src=\"semImagem.jpg\"/><h1 class=\"heading\">\((hinarios.number) + " - " + (hinarios.name))</h1><h4 class=\"authing\">\(String(describing: hinarios.compositor))</h4></div><div id=\"coro\"><h3>Coro</h3><p class=\"content\">\(String(describing: hinarios.estrofeCoroInicio))</p></div><div id=\"estrofe-prim\"><h3>1ª Estrofe</h3><p class=\"content\">\(String(describing: hinarios.estrofeUm))</p></div><div id=\"coro\"><h3>Coro</h3><p class=\"content\">\(String(describing: hinarios.estrofeCoroInicio))</p></div><div id=\"estrofe-segun\"><h3>2ª Estrofe</h3><p class=\"content\">\(String(describing: hinarios.estrofeDois))</p></div><div id=\"coro\"><h3>Coro</h3><p class=\"content\">\(String(describing: hinarios.estrofeCoroInicio))</p></div><div id=\"estrofe-terc\"><h3>3ª Estrofe</h3><p class=\"content\">\(String(describing: hinarios.estrofeTres))</p></div><div id=\"coro\"><h3>Coro</h3><p class=\"content\">\(String(describing: hinarios.estrofeCoroInicio))</p></div></div><br/></body></html>"
			...
			case 1...8:
				...
				let html = "<!doctype html><head><meta charset=\"UTF-8\"><title>Hinário Adventista do 7º Dia</title><link href=\"style.css\" rel=\"stylesheet\" type=\"text/css\"><body style=\"font-size:\(currentValueSlider)vw;font-family:\(currentValueFont);background-color:\(currentColorBack);\"><div class=\"container clearfix\"><div id=\"imagem-topo\" style=\"outline:none;\"><img class=\"img-class\" src=\"semImagem.jpg\"/><h1 class=\"heading\">\((hinarios.number) + " - " + (hinarios.name))</h1><h4 class=\"authing\">\(String(describing: hinarios.compositor))</h4></div><div id=\"estrofe-prim\"><h3>1ª Estrofe</h3><p class=\"content\">\(String(describing: hinarios.estrofeUm))</p></div><div id=\"coro\"><h3>Coro</h3><p class=\"content\">\(String(describing: hinarios.estrofeCoroNormal))</p></div><div id=\"estrofe-segun\"><h3>2ª Estrofe</h3><p class=\"content\">\(String(describing: hinarios.estrofeDois))</p></div><div id=\"coro\"><h3>Coro</h3><p class=\"content\">\(String(describing: hinarios.estrofeCoroNormal))</p></div><div id=\"estrofe-terc\"><h3>3ª Estrofe</h3><p class=\"content\">\(String(describing: hinarios.estrofeTres))</p></div><div id=\"coro\"><h3>Coro</h3><p class=\"content\">\(String(describing: hinarios.estrofeCoroNormal))</p></div><div id=\"estrofe-quart\"><h3>4ª Estrofe</h3><p class=\"content\">\(String(describing: hinarios.estrofeQuatro))</p></div><div id=\"coro\"><h3>Coro</h3><p class=\"content\">\(String(describing: hinarios.estrofeCoroNormal))</p></div></div><br/></body></html>"
			...
			case 1...9:
				...
				let html = "<!doctype html><head><meta charset=\"UTF-8\"><title>Hinário Adventista do 7º Dia</title><link href=\"style.css\" rel=\"stylesheet\" type=\"text/css\"><body style=\"font-size:\(currentValueSlider)vw;font-family:\(currentValueFont);background-color:\(currentColorBack);\"><div class=\"container clearfix\"><div id=\"imagem-topo\" style=\"outline:none;\"><img class=\"img-class\" src=\"semImagem.jpg\"/><h1 class=\"heading\">\((hinarios.number) + " - " + (hinarios.name))</h1><h4 class=\"authing\">\(String(describing: hinarios.compositor))</h4></div><div id=\"coro\"><h3>Coro</h3><p class=\"content\">\(String(describing: hinarios.estrofeCoroInicio))</p></div><div id=\"estrofe-prim\"><h3>1ª Estrofe</h3><p class=\"content\">\(String(describing: hinarios.estrofeUm))</p></div><div id=\"coro\"><h3>Coro</h3><p class=\"content\">\(String(describing: hinarios.estrofeCoroInicio))</p></div><div id=\"estrofe-segun\"><h3>2ª Estrofe</h3><p class=\"content\">\(String(describing: hinarios.estrofeDois))</p></div><div id=\"coro\"><h3>Coro</h3><p class=\"content\">\(String(describing: hinarios.estrofeCoroInicio))</p></div><div id=\"estrofe-terc\"><h3>3ª Estrofe</h3><p class=\"content\">\(String(describing: hinarios.estrofeTres))</p></div><div id=\"coro\"><h3>Coro</h3><p class=\"content\">\(String(describing: hinarios.estrofeCoroInicio))</p></div><div id=\"estrofe-quart\"><h3>4ª Estrofe</h3><p class=\"content\">\(String(describing: hinarios.estrofeQuatro))</p></div><div id=\"coro\"><h3>Coro</h3><p class=\"content\">\(String(describing: hinarios.estrofeCoroInicio))</p></div></div><br/></body></html>"
			...
			case 1...10:
				...
				let html = "<!doctype html><head><meta charset=\"UTF-8\"><title>Hinário Adventista do 7º Dia</title><link href=\"style.css\" rel=\"stylesheet\" type=\"text/css\"><body style=\"font-size:\(currentValueSlider)vw;font-family:\(currentValueFont);background-color:\(currentColorBack);\"><div class=\"container clearfix\"><div id=\"imagem-topo\" style=\"outline:none;\"><img class=\"img-class\" src=\"semImagem.jpg\"/><h1 class=\"heading\">\((hinarios.number) + " - " + (hinarios.name))</h1><h4 class=\"authing\">\(String(describing: hinarios.compositor))</h4></div><div id=\"estrofe-prim\"><h3>1ª Estrofe</h3><p class=\"content\">\(String(describing: hinarios.estrofeUm))</p></div><div id=\"coro\"><h3>Coro</h3><p class=\"content\">\(String(describing: hinarios.estrofeCoroNormal))</p></div><div id=\"estrofe-segun\"><h3>2ª Estrofe</h3><p class=\"content\">\(String(describing: hinarios.estrofeDois))</p></div><div id=\"coro\"><h3>Coro</h3><p class=\"content\">\(String(describing: hinarios.estrofeCoroNormal))</p></div></div><br/></body></html>"
			...
			case 1...11:
				...
				let html = "<!doctype html><head><meta charset=\"UTF-8\"><title>Hinário Adventista do 7º Dia</title><link href=\"style.css\" rel=\"stylesheet\" type=\"text/css\"><body style=\"font-size:\(currentValueSlider)vw;font-family:\(currentValueFont);background-color:\(currentColorBack);\"><div class=\"container clearfix\"><div id=\"imagem-topo\" style=\"outline:none;\"><img class=\"img-class\" src=\"semImagem.jpg\"/><h1 class=\"heading\">\((hinarios.number) + " - " + (hinarios.name))</h1><h4 class=\"authing\">\(String(describing: hinarios.compositor))</h4></div><div id=\"coro\"><h3>Coro</h3><p class=\"content\">\(String(describing: hinarios.estrofeCoroInicio))</p></div><div id=\"estrofe-prim\"><h3>1ª Estrofe</h3><p class=\"content\">\(String(describing: hinarios.estrofeUm))</p></div><div id=\"coro\"><h3>Coro</h3><p class=\"content\">\(String(describing: hinarios.estrofeCoroInicio))</p></div><div id=\"estrofe-segun\"><h3>2ª Estrofe</h3><p class=\"content\">\(String(describing: hinarios.estrofeDois))</p></div><div id=\"coro\"><h3>Coro</h3><p class=\"content\">\(String(describing: hinarios.estrofeCoroInicio))</p></div></div><br/></body></html>"
			...
			case 1...12:
				...
				let html = "<!doctype html><head><meta charset=\"UTF-8\"><title>Hinário Adventista do 7º Dia</title><link href=\"style.css\" rel=\"stylesheet\" type=\"text/css\"><body style=\"font-size:\(currentValueSlider)vw;font-family:\(currentValueFont);background-color:\(currentColorBack);\"><div class=\"container clearfix\"><div id=\"imagem-topo\" style=\"outline:none;\"><img class=\"img-class\" src=\"semImagem.jpg\"/><h1 class=\"heading\">\((hinarios.number) + " - " + (hinarios.name))</h1><h4 class=\"authing\">\(String(describing: hinarios.compositor))</h4></div><div id=\"estrofe-prim\"><h3>1ª Estrofe</h3><p class=\"content\">\(String(describing: hinarios.estrofeUm))</p></div><div id=\"coro\"><h3>Coro</h3><p class=\"content\">\(String(describing: hinarios.estrofeCoroNormal))</p></div></div><br/></body></html>"
			...
			case 1...13:
				...
				let html = "<!doctype html><head><meta charset=\"UTF-8\"><title>Hinário Adventista do 7º Dia</title><link href=\"style.css\" rel=\"stylesheet\" type=\"text/css\"><body style=\"font-size:\(currentValueSlider)vw;font-family:\(currentValueFont);background-color:\(currentColorBack);\"><div class=\"container clearfix\"><div id=\"imagem-topo\" style=\"outline:none;\"><img class=\"img-class\" src=\"semImagem.jpg\"/><h1 class=\"heading\">\((hinarios.number) + " - " + (hinarios.name))</h1><h4 class=\"authing\">\(String(describing: hinarios.compositor))</h4></div><div id=\"coro\"><h3>Coro</h3><p class=\"content\">\(String(describing: hinarios.estrofeCoroInicio))</p></div><div id=\"estrofe-prim\"><h3>1ª Estrofe</h3><p class=\"content\">\(String(describing: hinarios.estrofeUm))</p></div><div id=\"coro\"><h3>Coro</h3><p class=\"content\">\(String(describing: hinarios.estrofeCoroInicio))</p></div></div><br/></body></html>"
			...
			case 1...14:
				...
				let html = "<!doctype html><head><meta charset=\"UTF-8\"><title>Hinário Adventista do 7º Dia</title><link href=\"style.css\" rel=\"stylesheet\" type=\"text/css\"><body style=\"font-size:\(currentValueSlider)vw;font-family:\(currentValueFont);background-color:\(currentColorBack);\"><div class=\"container clearfix\"><div id=\"imagem-topo\" style=\"outline:none;\"><img class=\"img-class\" src=\"semImagem.jpg\"/><h1 class=\"heading\">\((hinarios.number) + " - " + (hinarios.name))</h1><h4 class=\"authing\">\(String(describing: hinarios.compositor))</h4></div><div id=\"estrofe-prim\"><h3>1ª Estrofe</h3><p class=\"content\">\(String(describing: hinarios.estrofeUm))</p></div><div id=\"coro\"><h3>Coro</h3><p class=\"content\">\(String(describing: hinarios.estrofeCoroNormal))</p></div><div id=\"estrofe-segun\"><h3>2ª Estrofe</h3><p class=\"content\">\(String(describing: hinarios.estrofeDois))</p></div><div id=\"coro\"><h3>Coro</h3><p class=\"content\">\(String(describing: hinarios.estrofeCoroNormal))</p></div><div id=\"estrofe-terc\"><h3>3ª Estrofe</h3><p class=\"content\">\(String(describing: hinarios.estrofeTres))</p></div><div id=\"coro\"><h3>Coro</h3><p class=\"content\">\(String(describing: hinarios.estrofeCoroNormal))</p></div><div id=\"estrofe-quart\"><h3>4ª Estrofe</h3><p class=\"content\">\(String(describing: hinarios.estrofeQuatro))</p></div><div id=\"coro\"><h3>Coro</h3><p class=\"content\">\(String(describing: hinarios.estrofeCoroNormal))</p></div><div id=\"estrofe-quin\"><h3>5ª Estrofe</h3><p class=\"content\">\(String(describing: hinarios.estrofeCinco))</p></div><div id=\"coro\"><h3>Coro</h3><p class=\"content\">\(String(describing: hinarios.estrofeCoroNormal))</p></div></div><br/></body></html>"
			...
			case 1...15:
				...
				let html = "<!doctype html><head><meta charset=\"UTF-8\"><title>Hinário Adventista do 7º Dia</title><link href=\"style.css\" rel=\"stylesheet\" type=\"text/css\"><body style=\"font-size:\(currentValueSlider)vw;font-family:\(currentValueFont);background-color:\(currentColorBack);\"><div class=\"container clearfix\"><div id=\"imagem-topo\" style=\"outline:none;\"><img class=\"img-class\" src=\"semImagem.jpg\"/><h1 class=\"heading\">\((hinarios.number) + " - " + (hinarios.name))</h1><h4 class=\"authing\">\(String(describing: hinarios.compositor))</h4></div><div id=\"coro\"><h3>Coro</h3><p class=\"content\">\(String(describing: hinarios.estrofeCoroInicio))</p></div><div id=\"estrofe-prim\"><h3>1ª Estrofe</h3><p class=\"content\">\(String(describing: hinarios.estrofeUm))</p></div><div id=\"coro\"><h3>Coro</h3><p class=\"content\">\(String(describing: hinarios.estrofeCoroInicio))</p></div><div id=\"estrofe-segun\"><h3>2ª Estrofe</h3><p class=\"content\">\(String(describing: hinarios.estrofeDois))</p></div><div id=\"coro\"><h3>Coro</h3><p class=\"content\">\(String(describing: hinarios.estrofeCoroInicio))</p></div><div id=\"estrofe-terc\"><h3>3ª Estrofe</h3><p class=\"content\">\(String(describing: hinarios.estrofeTres))</p></div><div id=\"coro\"><h3>Coro</h3><p class=\"content\">\(String(describing: hinarios.estrofeCoroInicio))</p></div><div id=\"estrofe-quart\"><h3>4ª Estrofe</h3><p class=\"content\">\(String(describing: hinarios.estrofeQuatro))</p></div><div id=\"coro\"><h3>Coro</h3><p class=\"content\">\(String(describing: hinarios.estrofeCoroInicio))</p></div><div id=\"estrofe-quin\"><h3>5ª Estrofe</h3><p class=\"content\">\(String(describing: hinarios.estrofeCinco))</p></div><div id=\"coro\"><h3>Coro</h3><p class=\"content\">\(String(describing: hinarios.estrofeCoroInicio))</p></div></div><br/></body></html>"
			...
			default:
				...
				let html = "<!doctype html><head><meta charset=\"UTF-8\"><title>Hinário Adventista do 7º Dia</title><link href=\"style.css\" rel=\"stylesheet\" type=\"text/css\"><body style=\"font-size:\(currentValueSlider)vw;font-family:\(currentValueFont);background-color:\(currentColorBack);\"><div class=\"container clearfix\"><div id=\"imagem-topo\" style=\"outline:none;\"><img class=\"img-class\" src=\"semImagem.jpg\"/><h1 class=\"heading\">\((hinarios.number) + " - " + (hinarios.name))</h1><h4 class=\"authing\">\(String(describing: hinarios.compositor))</h4></div><div id=\"coro\"><h3>Coro</h3><p class=\"content\">\(String(describing: hinarios.estrofeCoroInicio))</p></div></div><br/></body></html>"
			...
			case 1...1:
				...
				let html = "<!doctype html><head><meta charset=\"UTF-8\"><title>Hinário Adventista do 7º Dia</title><link href=\"style.css\" rel=\"stylesheet\" type=\"text/css\"><body style=\"font-size:\(currentValueSlider)vw;font-family:\(currentValueFont);background-color:\(currentColorBack);\"><div class=\"container clearfix\"><div id=\"imagem-topo\" style=\"outline:none;\"><img class=\"img-class\" src='\(fileURL.path)'/><h1 class=\"heading\">\((hinarios.number) + " - " + (hinarios.name))</h1><h4 class=\"authing\">\(String(describing: hinarios.compositor))</h4></div><div id=\"estrofe-prim\"><h3>1ª Estrofe</h3><p class=\"content\">\(String(describing: hinarios.estrofeUm))</p></div></div><br/></body></html>"
			...
			case 1...2:
				...
				let html = "<!doctype html><head><meta charset=\"UTF-8\"><title>Hinário Adventista do 7º Dia</title><link href=\"style.css\" rel=\"stylesheet\" type=\"text/css\"><body style=\"font-size:\(currentValueSlider)vw;font-family:\(currentValueFont);background-color:\(currentColorBack);\"><div class=\"container clearfix\"><div id=\"imagem-topo\" style=\"outline:none;\"><img class=\"img-class\" src='\(fileURL.path)'/><h1 class=\"heading\">\((hinarios.number) + " - " + (hinarios.name))</h1><h4 class=\"authing\">\(String(describing: hinarios.compositor))</h4></div><div id=\"estrofe-prim\"><h3>1ª Estrofe</h3><p class=\"content\">\(String(describing: hinarios.estrofeUm))</p></div><div id=\"estrofe-segun\"><h3>2ª Estrofe</h3><p class=\"content\">\(String(describing: hinarios.estrofeDois))</p></div></div><br/></body></html>"
			...
			case 1...3:
				...
				let html = "<!doctype html><head><meta charset=\"UTF-8\"><title>Hinário Adventista do 7º Dia</title><link href=\"style.css\" rel=\"stylesheet\" type=\"text/css\"></head><body style=\"font-size:\(currentValueSlider)vw;font-family:\(currentValueFont);background-color:\(currentColorBack);\"><div class=\"container clearfix\"><div id=\"imagem-topo\" style=\"outline:none;\"><img class=\"img-class\" src='\(fileURL.path)'/><h1 class=\"heading\">\((hinarios.number) + " - " + (hinarios.name))</h1><h4 class=\"authing\">\(String(describing: hinarios.compositor))</h4></div><div id=\"estrofe-prim\"><h3>1ª Estrofe</h3><p class=\"content\">\(String(describing: hinarios.estrofeUm))</p></div><div id=\"estrofe-segun\"><h3>2ª Estrofe</h3><p class=\"content\">\(String(describing: hinarios.estrofeDois))</p></div><div id=\"estrofe-terc\"><h3>3ª Estrofe</h3><p class=\"content\">\(String(describing: hinarios.estrofeTres))</p></div></div><br/></body></html>"
			...
			case 1...4:
				...
				let html = "<!doctype html><head><meta charset=\"UTF-8\"><title>Hinário Adventista do 7º Dia</title><link href=\"style.css\" rel=\"stylesheet\" type=\"text/css\"><body style=\"font-size:\(currentValueSlider)vw;font-family:\(currentValueFont);background-color:\(currentColorBack);\"><div class=\"container clearfix\"><div id=\"imagem-topo\" style=\"outline:none;\"><img class=\"img-class\" src='\(fileURL.path)'/><h1 class=\"heading\">\((hinarios.number) + " - " + (hinarios.name))</h1><h4 class=\"authing\">\(String(describing: hinarios.compositor))</h4></div><div id=\"estrofe-prim\"><h3>1ª Estrofe</h3><p class=\"content\">\(String(describing: hinarios.estrofeUm))</p></div><div id=\"estrofe-segun\"><h3>2ª Estrofe</h3><p class=\"content\">\(String(describing: hinarios.estrofeDois))</p><div id=\"estrofe-terc\"><h3>3ª Estrofe</h3><p class=\"content\">\(String(describing: hinarios.estrofeTres))</p></div><div id=\"estrofe-quart\"><h3>4ª Estrofe</h3><p class=\"content\">\(String(describing: hinarios.estrofeQuatro))</p></div></div><br/></body></html>"
			...
			case 1...6:
				...
				let html = "<!doctype html><head><meta charset=\"UTF-8\"><title>Hinário Adventista do 7º Dia</title><link href=\"style.css\" rel=\"stylesheet\" type=\"text/css\"><body style=\"font-size:\(currentValueSlider)vw;font-family:\(currentValueFont);background-color:\(currentColorBack);\"><div class=\"container clearfix\"><div id=\"imagem-topo\" style=\"outline:none;\"><img class=\"img-class\" src='\(fileURL.path)'/><h1 class=\"heading\">\((hinarios.number) + " - " + (hinarios.name))</h1><h4 class=\"authing\">\(String(describing: hinarios.compositor))</h4></div><div id=\"estrofe-prim\"><h3>1ª Estrofe</h3><p class=\"content\">\(String(describing: hinarios.estrofeUm))</p></div><div id=\"coro\"><h3>Coro</h3><p class=\"content\">\(String(describing: hinarios.estrofeCoroNormal))</p></div><div id=\"estrofe-segun\"><h3>2ª Estrofe</h3><p class=\"content\">\(String(describing: hinarios.estrofeDois))</p></div><div id=\"coro\"><h3>Coro</h3><p class=\"content\">\(String(describing: hinarios.estrofeCoroNormal))</p></div><div id=\"estrofe-terc\"><h3>3ª Estrofe</h3><p class=\"content\">\(String(describing: hinarios.estrofeTres))</p></div><div id=\"coro\"><h3>Coro</h3><p class=\"content\">\(String(describing: hinarios.estrofeCoroNormal))</p></div></div><br/></body></html>"
			...
			case 1...7:
				...
				let html = "<!doctype html><head><meta charset=\"UTF-8\"><title>Hinário Adventista do 7º Dia</title><link href=\"style.css\" rel=\"stylesheet\" type=\"text/css\"><body style=\"font-size:\(currentValueSlider)vw;font-family:\(currentValueFont);background-color:\(currentColorBack);\"><div class=\"container clearfix\"><div id=\"imagem-topo\" style=\"outline:none;\"><img class=\"img-class\" src='\(fileURL.path)'/><h1 class=\"heading\">\((hinarios.number) + " - " + (hinarios.name))</h1><h4 class=\"authing\">\(String(describing: hinarios.compositor))</h4></div><div id=\"coro\"><h3>Coro</h3><p class=\"content\">\(String(describing: hinarios.estrofeCoroInicio))</p></div><div id=\"estrofe-prim\"><h3>1ª Estrofe</h3><p class=\"content\">\(String(describing: hinarios.estrofeUm))</p></div><div id=\"coro\"><h3>Coro</h3><p class=\"content\">\(String(describing: hinarios.estrofeCoroInicio))</p></div><div id=\"estrofe-segun\"><h3>2ª Estrofe</h3><p class=\"content\">\(String(describing: hinarios.estrofeDois))</p></div><div id=\"coro\"><h3>Coro</h3><p class=\"content\">\(String(describing: hinarios.estrofeCoroInicio))</p></div><div id=\"estrofe-terc\"><h3>3ª Estrofe</h3><p class=\"content\">\(String(describing: hinarios.estrofeTres))</p></div><div id=\"coro\"><h3>Coro</h3><p class=\"content\">\(String(describing: hinarios.estrofeCoroInicio))</p></div></div><br/></body></html>"
			...
			case 1...10:
				...
				let html = "<!doctype html><head><meta charset=\"UTF-8\"><title>Hinário Adventista do 7º Dia</title><link href=\"style.css\" rel=\"stylesheet\" type=\"text/css\"><body style=\"font-size:\(currentValueSlider)vw;font-family:\(currentValueFont);background-color:\(currentColorBack);\"><div class=\"container clearfix\"><div id=\"imagem-topo\" style=\"outline:none;\"><img class=\"img-class\" src='\(fileURL.path)'/><h1 class=\"heading\">\((hinarios.number) + " - " + (hinarios.name))</h1><h4 class=\"authing\">\(String(describing: hinarios.compositor))</h4></div><div id=\"estrofe-prim\"><h3>1ª Estrofe</h3><p class=\"content\">\(String(describing: hinarios.estrofeUm))</p></div><div id=\"coro\"><h3>Coro</h3><p class=\"content\">\(String(describing: hinarios.estrofeCoroNormal))</p></div><div id=\"estrofe-segun\"><h3>2ª Estrofe</h3><p class=\"content\">\(String(describing: hinarios.estrofeDois))</p></div><div id=\"coro\"><h3>Coro</h3><p class=\"content\">\(String(describing: hinarios.estrofeCoroNormal))</p></div></div><br/></body></html>"
			...
			case 1...11:
				...
				let html = "<!doctype html><head><meta charset=\"UTF-8\"><title>Hinário Adventista do 7º Dia</title><link href=\"style.css\" rel=\"stylesheet\" type=\"text/css\"><body style=\"font-size:\(currentValueSlider)vw;font-family:\(currentValueFont);background-color:\(currentColorBack);\"><div class=\"container clearfix\"><div id=\"imagem-topo\" style=\"outline:none;\"><img class=\"img-class\" src='\(fileURL.path)'/><h1 class=\"heading\">\((hinarios.number) + " - " + (hinarios.name))</h1><h4 class=\"authing\">\(String(describing: hinarios.compositor))</h4></div><div id=\"coro\"><h3>Coro</h3><p class=\"content\">\(String(describing: hinarios.estrofeCoroInicio))</p></div><div id=\"estrofe-prim\"><h3>1ª Estrofe</h3><p class=\"content\">\(String(describing: hinarios.estrofeUm))</p></div><div id=\"coro\"><h3>Coro</h3><p class=\"content\">\(String(describing: hinarios.estrofeCoroInicio))</p></div><div id=\"estrofe-segun\"><h3>2ª Estrofe</h3><p class=\"content\">\(String(describing: hinarios.estrofeDois))</p></div><div id=\"coro\"><h3>Coro</h3><p class=\"content\">\(String(describing: hinarios.estrofeCoroInicio))</p></div></div><br/></body></html>"
			...
			case 1...12:
				...
				let html = "<!doctype html><head><meta charset=\"UTF-8\"><title>Hinário Adventista do 7º Dia</title><link href=\"style.css\" rel=\"stylesheet\" type=\"text/css\"><body style=\"font-size:\(currentValueSlider)vw;font-family:\(currentValueFont);background-color:\(currentColorBack);\"><div class=\"container clearfix\"><div id=\"imagem-topo\" style=\"outline:none;\"><img class=\"img-class\" src='\(fileURL.path)'/><h1 class=\"heading\">\((hinarios.number) + " - " + (hinarios.name))</h1><h4 class=\"authing\">\(String(describing: hinarios.compositor))</h4></div><div id=\"estrofe-prim\"><h3>1ª Estrofe</h3><p class=\"content\">\(String(describing: hinarios.estrofeUm))</p></div><div id=\"coro\"><h3>Coro</h3><p class=\"content\">\(String(describing: hinarios.estrofeCoroNormal))</p></div></div><br/></body></html>"
			...
			case 1...13:
				...
				let html = "<!doctype html><head><meta charset=\"UTF-8\"><title>Hinário Adventista do 7º Dia</title><link href=\"style.css\" rel=\"stylesheet\" type=\"text/css\"><body style=\"font-size:\(currentValueSlider)vw;font-family:\(currentValueFont);background-color:\(currentColorBack);\"><div class=\"container clearfix\"><div id=\"imagem-topo\" style=\"outline:none;\"><img class=\"img-class\" src='\(fileURL.path)'/><h1 class=\"heading\">\((hinarios.number) + " - " + (hinarios.name))</h1><h4 class=\"authing\">\(String(describing: hinarios.compositor))</h4></div><div id=\"coro\"><h3>Coro</h3><p class=\"content\">\(String(describing: hinarios.estrofeCoroInicio))</p></div><div id=\"estrofe-prim\"><h3>1ª Estrofe</h3><p class=\"content\">\(String(describing: hinarios.estrofeUm))</p></div><div id=\"coro\"><h3>Coro</h3><p class=\"content\">\(String(describing: hinarios.estrofeCoroInicio))</p></div></div><br/></body></html>"
			...
			default:
				...
				let html = "<!doctype html><head><meta charset=\"UTF-8\"><title>Hinário Adventista do 7º Dia</title><link href=\"style.css\" rel=\"stylesheet\" type=\"text/css\"><body style=\"font-size:\(currentValueSlider)vw;font-family:\(currentValueFont);background-color:\(currentColorBack);\"><div class=\"container clearfix\"><div id=\"imagem-topo\" style=\"outline:none;\"><img class=\"img-class\" src='\(fileURL.path)'/><h1 class=\"heading\">\((hinarios.number) + " - " + (hinarios.name))</h1><h4 class=\"authing\">\(String(describing: hinarios.compositor))</h4></div><div id=\"coro\"><h3>Coro</h3><p class=\"content\">\(String(describing: hinarios.estrofeCoroInicio))</p></div></div><br/></body></html>"
