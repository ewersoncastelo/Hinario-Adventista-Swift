...
//  Hinário
//
//  Created by Ewerson Castelo on 11/02/2018.
...
class BookmarkCell: UITableViewCell {
	...
	func setupViews() {
		...
		let itemCellStackView = UIStackView(arrangedSubviews: [nameHinoFav, numberHinoFav, authHinoFav])
